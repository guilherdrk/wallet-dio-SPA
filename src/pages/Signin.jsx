    ...
    return(
        ...
        rounded p-8 w-[35rem] h-[35rem]">
            ...
            <form className="flex flex-col justify-center gap-4 w-full text-2xl">
                <input type="email" placeholder="Email..." className="rounded p-2 w-full bg-white"/>
                <input type="password" placeholder="Password..." className="rounded p-2 w-full bg-white"/>
